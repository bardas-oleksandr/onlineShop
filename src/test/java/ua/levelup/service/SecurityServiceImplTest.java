...
//        User first = new User("user", "password", "email", User.UserState.ACTIVE.ordinal());
//        User second = new User("user", "other password", "email", User.UserState.ACTIVE.ordinal());
//        //WHEN-THEN
...
//        //GIVEN
//        final String PASSWORD = "password";
//        User user = new User("userName", null, "email", User.UserState.ACTIVE.ordinal());
