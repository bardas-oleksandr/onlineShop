...
//        order.setOrderPositionViewDtoList(orderPositionCreateDtoList);
//        return order;
//    }
//
...
//        return new Order(user, address, date, payed, orderState, paymentConditions);
//    }
//
...
//        User user = new User();
//
//        Integer orderState = Order.OrderState.REGISTERED.ordinal();
//        String address = request.getParameter(ADDRESS);
//        Integer paymentConditions = Integer.parseInt(request.getParameter(PAYMENT_CONDITIONS));
//        Timestamp date = new Timestamp(System.currentTimeMillis());
//        return new Order(user, address, date, false, orderState, paymentConditions);
//    }
//
